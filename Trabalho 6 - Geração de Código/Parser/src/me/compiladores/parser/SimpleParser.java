...
public class SimpleParser extends Parser {
	...
	public static class MainStatementContext extends ProgramPartContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitMainStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ProgramPartDefinitionMethodContext extends ProgramPartContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitProgramPartDefinitionMethod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				_prevctx = _localctx;
				setState(49);
				((FunctionCallContext)_localctx).func = methodCall();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						match(T__4);
						setState(57);
						((DivContext)_localctx).right = expression(7);
						}
						break;
					case 3:
						{
					...
					case 4:
						...
						match(T__6);
						setState(63);
						((MinContext)_localctx).right = expression(5);
						}
						break;
					}
					} 
	...
	public static class MethodDeclarationContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitMethodDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			match(T__9);
			setState(76);
			((MethodDeclarationContext)_localctx).vars = varList();
			setState(77);
			match(T__2);
			setState(78);
	...
	public static class VarListContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitVarList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final VarListContext varList() throws RecognitionException {
		...
		try {
			...
			case T__8:
				...
				{
				setState(80);
				((VarListContext)_localctx).varDeclaration = varDeclaration();
	...
	public static class MethodbodyContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitMethodbody(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final MethodbodyContext methodbody() throws RecognitionException {
		...
		try {
			...
			match(T__11);
			setState(92);
			((MethodbodyContext)_localctx).body = statementList();
			setState(93);
			match(T__12);
			setState(94);
			((MethodbodyContext)_localctx).ret = expression(0);
			setState(95);
			match(T__0);
			setState(96);
			match(T__13);
	...
	public static class StatementListContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitStatementList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MethodCallContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitMethodCall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final MethodCallContext methodCall() throws RecognitionException {
		...
		try {
			...
			{
			setState(106);
			((MethodCallContext)_localctx).methodname = match(IDENTIFIER);
			setState(107);
			match(T__9);
			setState(108);
			((MethodCallContext)_localctx).params = callList();
			setState(109);
			match(T__2);
			}
		}
	...
	public static class CallListContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleVisitor ) return ((SimpleVisitor<? extends T>)visitor).visitCallList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public